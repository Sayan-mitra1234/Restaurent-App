...
import { BookAIcon, Grid3X3, LayoutDashboard, Menu, Package, Plus, ShoppingCart} from 'lucide-react'
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center text-sm text-gray-500">
              ...
              <div>
                <div className="font-medium text-gray-900 hover:bg-text-red-500"> Admin User</div>
                <div className='cursor-pointer'>admin@example.com</div>
              </div>
            </div>
          </div>
          <div />
